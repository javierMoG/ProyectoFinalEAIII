...
for (i in 1:185){
  if(is.na(datos1[i,"CO2"])){
    ...
    datos1[i,"CO2"]<-min(datos1$CO2[datos1$PAIS==p], na.rm=T)
  }
}
...
datos1$ER[is.na(datos1$ER)]<-min(datos1$ER[datos1$PAIS==p], na.rm=T)

#AE
for (i in 1:185){
  if(is.na(datos1[i,"AE"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"AE"]<-min(datos1$AE[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"GINI"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"GINI"]<-min(datos1$GINI[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"SS"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"SS"]<-min(datos1$SS[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"SA"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"SA"]<-min(datos1$SA[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"P"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"P"]<-min(datos1$P[datos1$PAIS==p], na.rm=T)
  }
}
...
datos1$DE[is.na(datos1$DE)]<-min(datos1$DE[datos1$PAIS==p], na.rm=T)

#ESC
for (i in 1:185){
  if(is.na(datos1[i,"ESC"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"ESC"]<-min(datos1$ESC[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"HOM"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"HOM"]<-min(datos1$HOM[datos1$PAIS==p], na.rm=T)
  }
}
