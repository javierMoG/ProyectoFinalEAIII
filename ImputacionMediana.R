...
for (i in 1:185){
  if(is.na(datos1[i,"CO2"])){
    ...
    datos1[i,"CO2"]<-median(datos1$CO2[datos1$PAIS==p], na.rm=T)
  }
}
...
datos1$ER[is.na(datos1$ER)]<-median(datos1$ER[datos1$PAIS==p], na.rm=T)

#AE
for (i in 1:185){
  if(is.na(datos1[i,"AE"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"AE"]<-median(datos1$AE[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"GINI"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"GINI"]<-median(datos1$GINI[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"SS"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"SS"]<-median(datos1$SS[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"SA"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"SA"]<-median(datos1$SA[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"P"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"P"]<-median(datos1$P[datos1$PAIS==p], na.rm=T)
  }
}
...
datos1$DE[is.na(datos1$DE)]<-median(datos1$DE[datos1$PAIS==p], na.rm=T)

#ESC
for (i in 1:185){
  if(is.na(datos1[i,"ESC"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"ESC"]<-median(datos1$ESC[datos1$PAIS==p], na.rm=T)
  }
}
...
for (i in 1:185){
  if(is.na(datos1[i,"HOM"])){
    p<-as.character(datos1[i,"PAIS"])
    datos1[i,"HOM"]<-median(datos1$HOM[datos1$PAIS==p], na.rm=T)
  }
}
